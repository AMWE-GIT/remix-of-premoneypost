      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative w-full aspect-[2/1] md:aspect-[3/1] lg:aspect-[4/1] rounded-2xl overflow-hidden bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f0f1a]">
          ...
          <div className="absolute inset-0 opacity-20">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,_#65B741_1px,_transparent_1px)] bg-[length:40px_40px]" />
          </div>
          ...
          <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-10 lg:p-12">
            <div className="max-w-2xl">
              ...
              <Button 
                ...
                className="bg-[#10B981] hover:bg-[#059669] hover:shadow-lg hover:shadow-[#10B981]/20 text-white font-medium px-6 py-3 rounded-xl transition-all duration-300"
              >
                Request an invite
              </Button>
