      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center gap-6">
            <span className="text-white font-medium text-lg md:text-xl">PreMoneyPost®</span>
            <a 
              href="https://linkedin.com" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-10 h-10 rounded-md border border-gray-700 hover:border-white transition-colors"
            >
          ...
          <p className="text-white/50 text-xs font-source-sans">
            © {new Date().getFullYear()} PreMoneyPost®. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
